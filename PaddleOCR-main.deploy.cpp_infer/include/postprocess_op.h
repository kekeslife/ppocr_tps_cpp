...
public:
  ...
  void GetContourAreaPoint(const std::vector<cv::Point>& box,
      float unclip_ratio, float& distance);

  cv::RotatedRect UnClip(std::vector<std::vector<float>> box,
                         const float &unclip_ratio);

  cv::RotatedRect UnClipPoint(std::vector<cv::Point> box,
      const float& unclip_ratio, std::vector<cv::Point>& boxes);
  ...
  float BoxScoreFastPoint(std::vector<cv::Point> box_array, cv::Mat pred);
  ...
  std::vector<std::vector<std::vector<int>>>
      PolygonsFromBitmap(const cv::Mat pred, const cv::Mat bitmap,
          const float& box_thresh, const float& det_db_unclip_ratio,
          const std::string& det_db_score_mode,
  ...
  std::vector<std::vector<std::vector<int>>> 
      FilterTagDetResOnlyClip(std::vector<std::vector<std::vector<int>>> boxes,
                  float ratio_h, float ratio_w, cv::Mat srcimg);
