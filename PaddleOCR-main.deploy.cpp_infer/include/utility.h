...
public:
  ...
  static std::vector<std::vector<int>> Mat2Vector(cv::Mat mat);
  ...
  static cv::Mat GetMinareaRectCrop(const cv::Mat& srcimage,
      std::vector<std::vector<int>> box);
  ...
  static void Utility::Print_vec_int(std::vector<std::vector<int>> box, const std::string& title);
