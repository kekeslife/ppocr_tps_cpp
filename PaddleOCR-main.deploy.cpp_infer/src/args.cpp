...
// detection related
// 检测模型
DEFINE_string(det_model_dir, "./models/en_PP-OCRv3_det_infer", "Path of det inference model.");
//DEFINE_string(det_model_dir, "./models/det_sast_tt", "Path of det inference model.");
...
// recognition related
// 识别模型
DEFINE_string(rec_model_dir, "./models/en_PP-OCRv4_rec_infer", "Path of rec inference model.");
DEFINE_int32(rec_batch_num, 6, "rec_batch_num.");
// 文字
DEFINE_string(rec_char_dict_path, "./models/en_dict.txt",
              "Path of dictionary.");
