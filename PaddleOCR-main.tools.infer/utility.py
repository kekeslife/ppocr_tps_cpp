...
def get_rotate_crop_image(img, points):
    ...
    # print('img_crop:',img_crop_width,img_crop_height)
    # print('pts_std:',pts_std)
...
def get_minarea_rect_crop(img, points):
    ...
    # print(list(cv2.boxPoints(bounding_box)))
    ...
    # print("get_minarea_rect_crop",box)
